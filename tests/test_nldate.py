...
def test_in_n_days_from_tomorrow():
    assert parse("four days from tomorrow", today=date(2026, 5, 13)) == date(2026, 5, 18)

def test_in_n_days_from_the_day_after_tomorrow():
    assert parse("seven days from the day after tomorrow", today=date(2026, 5, 13)) == date(2026, 5, 22)

def test_in_n_days_from_yesterday():
    assert parse("four days from yesterday", today=date(2026, 5, 13)) == date(2026, 5, 16)

def test_in_n_days_before_yesterday():
    assert parse("four days before yesterday", today=date(2026, 5, 13)) == date(2026, 5, 8)

def test_in_n_days_before_the_day_before_yesterday():
    assert parse("four days before the day before yesterday", today=date(2026, 5, 13)) == date(2026, 5, 7)